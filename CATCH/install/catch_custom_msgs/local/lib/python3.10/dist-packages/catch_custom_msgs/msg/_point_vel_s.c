...
bool catch_custom_msgs__msg__point_vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("catch_custom_msgs.msg._point_vel.PointVel", full_classname_dest, 41) == 0);
  }
  catch_custom_msgs__msg__PointVel * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PointVel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("catch_custom_msgs.msg._point_vel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointVel");
