...
#ifndef ROS2_ARUCO_INTERFACES__SRV__DETAIL__STORE_TRANSFORM__FUNCTIONS_H_
#define ROS2_ARUCO_INTERFACES__SRV__DETAIL__STORE_TRANSFORM__FUNCTIONS_H_
...
/// Initialize srv/StoreTransform message.
/**
...
/// Finalize srv/StoreTransform message.
/**
...
/// Create srv/StoreTransform message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_aruco_interfaces__srv__StoreTransform_Request__init().
...
/// Destroy srv/StoreTransform message.
/**
 * It calls
 * ros2_aruco_interfaces__srv__StoreTransform_Request__fini()
...
/// Check for srv/StoreTransform message equality.
/**
...
/// Copy a srv/StoreTransform message.
/**
...
/// Initialize array of srv/StoreTransform messages.
/**
...
/// Finalize array of srv/StoreTransform messages.
/**
 * It calls
 * ros2_aruco_interfaces__srv__StoreTransform_Request__fini()
...
/// Create array of srv/StoreTransform messages.
/**
 * It allocates the memory for the array and calls
 * ros2_aruco_interfaces__srv__StoreTransform_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StoreTransform messages.
/**
 * It calls
 * ros2_aruco_interfaces__srv__StoreTransform_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StoreTransform message array equality.
/**
...
/// Copy an array of srv/StoreTransform messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2_aruco_interfaces__srv__StoreTransform_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_aruco_interfaces
...
/**
 * It calls
 * ros2_aruco_interfaces__srv__StoreTransform_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_aruco_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros2_aruco_interfaces__srv__StoreTransform_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2_aruco_interfaces
...
/**
 * It calls
 * ros2_aruco_interfaces__srv__StoreTransform_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS2_ARUCO_INTERFACES__SRV__DETAIL__STORE_TRANSFORM__FUNCTIONS_H_
